                                ...
                                <div class="articles-horizontal">
                                    @if(!empty($blogs))
                                        @foreach($blogs as $blog)
                                            <article>
                                                <a class="link-img" href="{{ route('blogs', $blog->alias) }}"
                                                   rel="nofollow">
                                                    <img title="{{ $blog->blog_img->title }}"
                                                         alt="{{ $blog->blog_img->alt }}"
                                                         src="{{ asset('/images/blog/middle') . '/' . $blog->blog_img->path }}">
                                                </a>
                                                <div class="title-time">
                                                    <time>
                                                        @if(strlen($blog->created) < 6) <i
                                    ...
                                    @if($blogs->lastPage() > 1)
                                        <ul>
                                            @if($blogs->currentPage() !== 1)
                                                <li>
                                                    <a rel="prev" href="{{ $blogs->url(($blogs->currentPage() - 1)) }}"
                                                       class="prev">
                                                        <
                                                    </a>
                                                </li>
                                            ...
                                            @if($blogs->currentPage() !== $blogs->lastPage())
                                                <li>
                                                    <a rel="next" href="{{ $blogs->url(($blogs->currentPage() + 1)) }}"
                                                       class="next">
                                                        >
                                                    </a>
                                                </li>
