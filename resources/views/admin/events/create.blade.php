...
<div class="row">
    ...
    <div>
        {!! Form::text('short_title', old('short_title') ? : '' , ['placeholder'=>'До 32 символов', 'id'=>'short_title', 'class'=>'form-control']) !!}
    </div>
</div>
<div class="row">
...
<div class="row">
    ...
    <div>
        {!! Form::text('extmail', old('extmail') ? : '' ,
         ['placeholder'=>'event@mail.com', 'id'=>'extmail', 'class'=>'form-control alert-danger']) !!}
    </div>
</div>
<hr>
